...
<div class="mx-auto h-full flex justify-center items-center bg-gray-300">
    <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
        ...
        <h1 class="text-white text-3xl pt-8">Now you can reset your password!</h1>
        ...
        <form method="POST" action="{{ route('password.update') }}" class="pt-8">
            ...
            <div class="relative">
                ...
                <div class="col-md-6">
                    <input id="email" type="email" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="email" required autocomplete="email" placeholder="your@email.com">
            ...
            <div class="relative pt-3">
                ...
                <div class="col-md-6">
                    <input id="password" type="password" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="password" required autocomplete="current-password" placeholder="Password">
            ...
            <div class="relative pt-3">
                ...
                <div class="col-md-6">
                    <input id="password-confirm" type="password" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="password-confirm" required autocomplete="password-confirm" placeholder="Confirm">
